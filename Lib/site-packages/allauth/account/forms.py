...
class LoginForm(forms.Form):
    ...
    error_messages = {
        ...
        "email_password_mismatch": _(
            "Указанный вами адрес электронной почты или пароль неверны."
        ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Логин"), "autocomplete": "username"}
            )
...
class BaseSignupForm(_base_signup_form_class()):
    ...
    firstname = forms.CharField(
        ...
        max_length = 30,
                 widget = forms.TextInput(
        attrs={"placeholder": _("Имя"), "autocomplete": "firstname"}
    ),
    )
    lastname = forms.CharField(
        ...
        max_length=30,
        widget=forms.TextInput(
            attrs={"placeholder": _("Фамилия"), "autocomplete": "lastname"}
        ),
    )
    phone = forms.CharField(
        ...
        min_length=11,
        widget=forms.TextInput(
            attrs={"type": "phone","placeholder": _("Телефон"), "autocomplete": "phone"}
        ),
    )
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.SIGNUP_PASSWORD_ENTER_TWICE:
            self.fields["password2"] = PasswordField(label=_("Подтвердите пароль"))
